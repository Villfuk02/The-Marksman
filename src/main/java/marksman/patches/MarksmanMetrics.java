...
public class MarksmanMetrics {
    ...
    public static class SendPostPatch {
        ...
        public static void Prefix(Metrics __instance, @ByRef String[] url, String fileName) {
            if (AbstractDungeon.player.chosenClass == TheMarksmanEnum.THE_MARKSMAN) {
                url[0] = "http://themarksmanmod.000webhostapp.com/upload/";
            }
        }
    }
    ...
    public static class RunPatch {
        ...
        public static void Postfix(Metrics __instance) {
            if (__instance.type == Metrics.MetricRequestType.UPLOAD_METRICS && AbstractDungeon.player.chosenClass == TheMarksmanEnum.THE_MARKSMAN) {
                try {
